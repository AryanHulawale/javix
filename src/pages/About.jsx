...
const stats = [
  ...
  { icon: Users, value: "25", label: "Engineers & Designers" },
  { icon: Globe, value: "4", label: "Countries Served" },
  { icon: Rocket, value: "2+", label: "Years in Business" },
];
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10 text-center">
        <ScrollFadeIn>
          ...
          <p className="text-white/70 mt-6 max-w-2xl mx-auto leading-relaxed">
           JAVIX is an elite strike team of senior engineers. We don't just build features; we architect scalable solutions for founders and enterprises who can't afford to fail.
          </p>
        </ScrollFadeIn>
      </div>
    </section>
