...
const services = [
  { icon: Code2, title: "Web Application Development", desc: "Robust, scalable web platforms engineered for performance and clarity." },
  { icon: Smartphone, title: "Mobile App Engineering", desc: "Native and cross-platform mobile experiences crafted end-to-end." },
  { icon: Cloud, title: "Cloud & DevOps", desc: "Resilient cloud infrastructure with automated CI/CD pipelines." },
  { icon: Database, title: "Data Engineering", desc: "Reliable data platforms that turn signals into decisions." },
  { icon: ShieldCheck, title: "Cybersecurity", desc: "Defense-in-depth security baked into every layer of your stack." },
  { icon: Sparkles, title: "AI Solutions", desc: "Production-grade AI integrations that deliver measurable lift." },
];
...
const Home = () => {
  ...
  Schedule Demo <ArrowRight size={18} />
            ...
            <div className="mt-10 flex items-center gap-8 text-white/70 text-sm">
              <div><div className="text-white text-2xl font-extrabold">12+</div>Years</div>
              <div className="w-px h-10 bg-white/15" />
              <div><div className="text-white text-2xl font-extrabold">240+</div>Projects</div>
              <div className="w-px h-10 bg-white/15" />
        ...
        <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <ScrollFadeIn className="relative">
            ...
            <div className="absolute -bottom-6 -right-4 javix-glass rounded-2xl px-5 py-4 hidden md:block">
              <div className="text-[10px] tracking-widest font-semibold text-[#0a1230]/60">SINCE 2013</div>
              <div className="text-xl font-extrabold text-[#0a1230]">12+ years of craft</div>
            </div>
          </ScrollFadeIn>
            ...
            {services.map((s, i) => (
              <ScrollFadeIn key={s.title} delay={i * 80}>
                <div className="javix-card p-7 h-full flex flex-col items-start" data-testid={`service-card-${i}`}>
                  ...
                  <Link to="/services" className="javix-link mt-5 inline-flex items-center gap-1 text-sm" data-testid={`service-learn-more-${i}`}>
