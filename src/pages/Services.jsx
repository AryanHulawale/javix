...
const services = [
  { icon: Code2, title: "Web Application Development", desc: "Robust, scalable web platforms engineered for performance and clarity.", tags: ["React", "Next.js", "Node"] },
  { icon: Smartphone, title: "Mobile App Engineering", desc: "Native and cross-platform mobile experiences crafted end-to-end.", tags: ["iOS", "Android", "RN"] },
  { icon: Cloud, title: "Cloud & DevOps", desc: "Resilient cloud infrastructure with automated CI/CD pipelines.", tags: ["AWS", "GCP", "K8s"] },
  { icon: Database, title: "Data Engineering", desc: "Reliable data platforms that turn signals into decisions.", tags: ["Snowflake", "dbt", "Airflow"] },
  { icon: ShieldCheck, title: "Cybersecurity", desc: "Defense-in-depth security baked into every layer of your stack.", tags: ["SOC2", "ZeroTrust", "Pen-test"] },
  { icon: Sparkles, title: "AI Solutions", desc: "Production-grade AI integrations that deliver measurable lift.", tags: ["LLM", "RAG", "Eval"] },
  { icon: Layers, title: "Product Design", desc: "Discovery, UX architecture, and pixel-perfect interface systems.", tags: ["Research", "Figma", "DS"] },
  { icon: GitBranch, title: "Platform Engineering", desc: "Internal developer platforms that compound team velocity.", tags: ["IDP", "DX", "Tooling"] },
  { icon: Bot, title: "AI Automation", desc: "Workflow automation with agents that ship measurable hours back.", tags: ["Agents", "Ops", "RPA"] },
];
          ...
          {services.map((s, i) => (
            <ScrollFadeIn key={s.title} delay={i * 60}>
              <div className="javix-card p-7 h-full flex flex-col items-start" data-testid={`services-card-${i}`}>
                ...
                <Link to="/contact" className="javix-link mt-5 inline-flex items-center gap-1 text-sm" data-testid={`services-cta-${i}`}>
